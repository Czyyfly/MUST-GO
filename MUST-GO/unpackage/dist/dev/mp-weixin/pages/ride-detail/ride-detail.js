  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        o: common_vendor.t(ride.value.remark || "车主很懒，没有留下备注信息~"),
        p: common_vendor.t(ride.value.seats > 0 ? "确认预订并支付" : "座位已满"),
        q: ride.value.seats <= 0,
        r: common_vendor.o(handleJoin, "97")
      } : {
        s: common_vendor.p({
          type: "info-filled",
          size: "60",
